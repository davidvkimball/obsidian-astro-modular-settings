	...
	getItems(): CommandOption[] {
		...
		if (commandRegistry && typeof commandRegistry.listCommands === 'function') {
			try {
				...
				console.warn('[Astro Modular Settings] Error getting commands via listCommands():', e);
			}
		}
		...
		try {
			...
			console.warn('[Astro Modular Settings] Error getting commands via registry:', e);
		}
		...
		try {
			...
			console.warn('[Astro Modular Settings] Error getting commands via internal registry:', e);
		}
